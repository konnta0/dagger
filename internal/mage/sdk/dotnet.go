...
const (
	dotnetGeneratedAPIPath = "sdk/go/api.gen.go"
)
...
func (t Dotnet) Lint(ctx context.Context) error {
	...
	}, dotnetGeneratedAPIPath)
}

// Test tests the Go SDK
func (t Dotnet) Test(ctx context.Context) error {
	c, err := dagger.Connect(ctx, dagger.WithLogOutput(os.Stderr))
	if err != nil {
		return err
	}
...
func (t Dotnet) Generate(ctx context.Context) error {
	c, err := dagger.Connect(ctx, dagger.WithLogOutput(os.Stderr))
	if err != nil {
		return err
	}
...
func (t Dotnet) Publish(ctx context.Context, tag string) error {
	c, err := dagger.Connect(ctx, dagger.WithLogOutput(os.Stderr))
	if err != nil {
		return err
	}
...
func (t Dotnet) Bump(ctx context.Context, version string) error {
